...
.L10:
 ...
 ;  main.c:52:         switch ( ch )
	...
	breq .L6		 ; ,
.L7:
 ;  main.c:68:         VBuffer_Clear();
	call VBuffer_Clear	 ; 
 ;  main.c:69:         CalculateTranformCache( &Cam );
	movw r24,r28	 ; ,
	adiw r24,1	 ; ,
	call CalculateTranformCache	 ; 
 ;  main.c:70:         CDrawArgs_DrawOnDisplayBufferPerspective( &Arg, &Cam );
	movw r22,r28	 ; ,
	subi r22,-1	 ; ,
	sbci r23,-1	 ; ,
	movw r24,r28	 ; ,
...
.L4:
 ;  main.c:52:         switch ( ch )
	...
	cpi r24,lo8(113)	 ;  ch,
	brne .L7		 ; ,
 ;  main.c:55:             Cam.ReadOnly_DirectionRadian -= fixedpt_rconst( LITERAL_PI * 0.01 ); break;
