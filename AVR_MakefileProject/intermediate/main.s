...
.L__stack_usage = 0
 ...
 ;  main.c:48: 	TCCR0 = mask( WGM01, CS02, CS01, CS00 ); 
...
/* stack size = 0 */
.L__stack_usage = 0
 ;  main.c:110: 	Records[RecordIdx] = EncodedRecord;
 ...
 ;  main.c:111: 	++RecordIdx;
	subi r25,lo8(-(1))	 ;  _15,
	sts RecordIdx,r25	 ;  RecordIdx, _15
 ;  main.c:112: 	MaxRecord = max16( MaxRecord, RecordIdx );
	lds r18,MaxRecord	 ;  MaxRecord, MaxRecord
	mov r20,r25	 ;  _15, _15
	ldi r21,0		 ;  _15
 ;  math.h:6: inline int16 max16( int16 a, int16 b ) { return a > b ? a : b; }
	ldi r19,0		 ;  MaxRecord
...
.L4:
 ...
 ;  main.c:113: 	if ( RecordIdx == ARRAYCOUNT( Records ) )
	cpi r25,lo8(8)	 ;  _15,
	breq .L6		 ; ,
/* epilogue start */
 ;  main.c:117: }
...
/* stack size = 0 */
.L__stack_usage = 0
 ;  main.c:121: 	return is_true( TCCR1B & 0b11 );
...
.L__stack_usage = 8 + __gcc_isr.n_pushed
 ...
 ;  main.c:126: 	if ( IsStopwatchRunning() )
...
.L__stack_usage = 4 + __gcc_isr.n_pushed
 ...
 ;  main.c:135: 	if ( StopwatchDisplayMode == ESDM_Stopwatch
	...
	brne .L17		 ; ,
 ;  main.c:136: 		 && MaxRecord > 0 )
	tst r25		 ;  pretmp_21
	breq .L17		 ; ,
 ;  main.c:138: 		StopwatchDisplayMode = ESDM_BrowseRecord;
	ldi r20,lo8(1)	 ;  tmp48,
	ldi r21,0		 ; 
	sts StopwatchDisplayMode+1,r21	 ;  StopwatchDisplayMode, tmp48
	sts StopwatchDisplayMode,r20	 ;  StopwatchDisplayMode, tmp48
 ;  main.c:140: 		StopwatchBrowseCursor = RecordIdx; 
	mov r24,r18	 ;  iftmp.18_10, pretmp_22
 ;  main.c:154: 	StopwatchBrowseCursor = StopwatchBrowseCursor < MaxRecord ? StopwatchBrowseCursor : 0;
...
.L21:
	...
	rjmp .L20		 ; 
.L17:
 ;  main.c:144: 		++StopwatchBrowseCursor;
	lds r24,StopwatchBrowseCursor	 ;  StopwatchBrowseCursor, StopwatchBrowseCursor
	subi r24,lo8(-(1))	 ;  iftmp.18_10,
 ;  main.c:146: 		if ( StopwatchBrowseCursor == RecordIdx 
	cp r24,r18		 ;  iftmp.18_10, pretmp_22
	breq .L19		 ; ,
 ;  main.c:147: 			 || ( StopwatchBrowseCursor == MaxRecord && RecordIdx == 0 ) )
	cp r24,r25		 ;  iftmp.18_10, pretmp_21
	breq .L28		 ; ,
.L18:
 ;  main.c:154: 	StopwatchBrowseCursor = StopwatchBrowseCursor < MaxRecord ? StopwatchBrowseCursor : 0;
...
.L28:
 ;  main.c:147: 			 || ( StopwatchBrowseCursor == MaxRecord && RecordIdx == 0 ) )
	...
	rjmp .L21	 ; 
.L19:
 ;  main.c:149: 			StopwatchDisplayMode = ESDM_Stopwatch;
...
.L34:
 ...
 ;  main.c:254: 	const bool bCnt100 = bCnt10 && N10 == 9;
	...
	breq .L35		 ; ,
.L31:
 ;  main.c:258: 	if ( bCnt10 ) N10 = ( N10 + 1 ) % 10;     // 10자리 +1
 ...
 ;  main.c:258: 	if ( bCnt10 ) N10 = ( N10 + 1 ) % 10;     // 10자리 +1
	...
	rjmp .L30		 ; 
.L35:
 ;  main.c:255: 	const bool bCnt1000 = bCnt100 && bCnt10 && N100 == 9;
	lds r19,N100	 ;  N100.44_8, N100
 ;  main.c:255: 	const bool bCnt1000 = bCnt100 && bCnt10 && N100 == 9;
	cpi r19,lo8(9)	 ;  N100.44_8,
	brne .L32		 ; ,
 ;  main.c:256: 	if ( bCnt1000 ) N1000 = ( N1000 + 1 ) % 10;
	lds r24,N1000	 ;  N1000, N1000
	ldi r25,0		 ;  N1000
	adiw r24,1	 ;  tmp66,
 ;  main.c:256: 	if ( bCnt1000 ) N1000 = ( N1000 + 1 ) % 10;
...
.L32:
 ;  main.c:257: 	if ( bCnt100 ) N100 = ( N100 + 1 ) % 10;   // 100자리 +1
...
.L__stack_usage = 6 + __gcc_isr.n_pushed
	lds r24,idx.2004	 ;  pretmp_34, idx
	ldi r25,0		 ;  _35
 ;  main.c:174: 	if ( StopwatchDisplayMode == ESDM_Stopwatch )
	...
	brne .L37		 ; ,
 ;  main.c:177: 		HexToDisplay = *nums[idx];
	movw r30,r24	 ;  tmp64, _35
	lsl r30	 ;  tmp64
	rol r31	 ;  tmp64
	subi r30,lo8(-(nums.2007))	 ;  tmp65,
	sbci r31,hi8(-(nums.2007))	 ;  tmp65,
 ;  main.c:177: 		HexToDisplay = *nums[idx];
...
.L38:
 ;  main.c:275: 	PORTF = 0xff ^ ( 0x01 << ( 4 + idx ) );
 ...
 ;  main.c:276: 	PORTB = seg_pat[digit & 0xf];
 ...
 ;  main.c:187: 	idx = ++idx < max_idx ? idx : 0;
	lds r24,idx.2004	 ;  idx, idx
	subi r24,lo8(-(1))	 ;  _13,
 ;  main.c:187: 	idx = ++idx < max_idx ? idx : 0;
	cpi r24,lo8(4)	 ;  _13,
	brlo .L39		 ; ,
...
/* epilogue start */
 ;  main.c:188: }
	...
	reti	
.L37:
 ;  main.c:181: 		uint16 BrowsingRecord = Records[StopwatchBrowseCursor];
 ...
 ;  main.c:181: 		uint16 BrowsingRecord = Records[StopwatchBrowseCursor];
	...
	subi r30,lo8(-(Records))	 ;  tmp71,
	sbci r31,hi8(-(Records))	 ;  tmp71,
 ;  main.c:182: 		HexToDisplay = BrowsingRecord >> ( 4 * idx );
...
.L__stack_usage = 0 + __gcc_isr.n_pushed
 ;  main.c:197: 	N1000 = N100 = N10 = N1 = 0;
...
/* stack size = 6...10 */
.L__stack_usage = 6 + __gcc_isr.n_pushed
 ;  main.c:209: 	LedOutput >>= MaxRecord;
 ...
 ;  main.c:211: 	if ( ++FlickerCount > MAX_FLICKER_COUNT )
	lds r24,FlickerCount.2026	 ;  FlickerCount, FlickerCount
	subi r24,lo8(-(1))	 ;  _5,
 ;  main.c:211: 	if ( ++FlickerCount > MAX_FLICKER_COUNT )
	sts FlickerCount.2026,r24	 ;  FlickerCount, _5
	lds r20,bUnlitFocusedIndex.2027	 ;  pretmp_29, bUnlitFocusedIndex
	lds r21,bUnlitFocusedIndex.2027+1	 ;  pretmp_29, bUnlitFocusedIndex
	cpi r24,lo8(16)	 ;  _5,
	brlo .L44		 ; ,
 ;  main.c:213: 		FlickerCount = 0;
	sts FlickerCount.2026,__zero_reg__	 ;  FlickerCount,
 ;  main.c:214: 		bUnlitFocusedIndex = !bUnlitFocusedIndex;
	ldi r22,lo8(1)	 ;  tmp84,
	ldi r24,0		 ;  tmp85
 ...
 ;  main.c:214: 		bUnlitFocusedIndex = !bUnlitFocusedIndex;
	sts bUnlitFocusedIndex.2027+1,r21	 ;  bUnlitFocusedIndex, pretmp_29
	sts bUnlitFocusedIndex.2027,r20	 ;  bUnlitFocusedIndex, pretmp_29
.L44:
 ;  main.c:217: 	if ( bUnlitFocusedIndex )
	or r20,r21	 ;  pretmp_29
	breq .L46		 ; ,
 ;  main.c:219: 		if ( StopwatchDisplayMode == ESDM_BrowseRecord )
	...
	breq .L55		 ; ,
 ;  main.c:225: 			LedOutput |= ( 0x80u >> RecordIdx );
...
.L54:
 ...
 ;  main.c:214: 		bUnlitFocusedIndex = !bUnlitFocusedIndex;
	...
	rjmp .L44		 ; 
.L55:
 ;  main.c:221: 			LedOutput |= ( 0x80u >> StopwatchBrowseCursor );
...
.L__stack_usage = 0
.L57:
 ;  main.c:324: 	uint8 CurrentSwitchState = ~PINE & SWITCH_PIN_MASK;
...
/* stack size = 0 */
.L__stack_usage = 0
 ;  main.c:77: 	InitializeEnvironment();
	call InitializeEnvironment	 ; 
 ;  main.c:82: 		UpdateLight();
	call UpdateLight	 ; 
	.size	main, .-main
	.text
...
/* stack size = 0 */
.L__stack_usage = 0
 ;  main.c:265: 	pos = ( pos + 1 ) % 4;        // 입력 자리 이동
	lds r24,pos	 ;  pos, pos
	ldi r25,0		 ;  pos
	adiw r24,1	 ;  tmp49,
 ;  main.c:265: 	pos = ( pos + 1 ) % 4;        // 입력 자리 이동
...
/* epilogue start */
	...
	.local	bUnlitFocusedIndex.2027
	.comm	bUnlitFocusedIndex.2027,2,1
	.local	FlickerCount.2026
	.comm	FlickerCount.2026,1,1
	.section	.rodata
	.type	nums.2007, @object
	.size	nums.2007, 8
nums.2007:
	.word	N1
	.word	N10
