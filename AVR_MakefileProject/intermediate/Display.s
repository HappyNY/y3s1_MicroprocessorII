...
/* stack size = 0 */
.L__stack_usage = 0
 ;  Display.c:14: 	LCDBuffer = Malloc( LCD_BUFFER_LENGTH );
	ldi r24,0		 ; 
	ldi r25,lo8(15)	 ; ,
	call Malloc	 ; 
 ;  Display.c:14: 	LCDBuffer = Malloc( LCD_BUFFER_LENGTH );
...
/* stack size = 13 */
.L__stack_usage = 13
 ;  Display.c:24: 	int16 dx = abs8( x1 - x0 );
...
.L5:
 ;  Display.c:24: 	int16 dx = abs8( x1 - x0 );
	...
	lsl r0		 ; 
	sbc r17,r17	 ; 
 ;  Display.c:25: 	int8 sx = x0 < x1 ? 1 : -1;
...
.L7:
 ;  Display.c:26: 	int16 dy = -abs8( y1 - 0 );
	mov __tmp_reg__,r8	 ; 
	lsl r0		 ; 
	sbc r9,r9	 ; 
 ;  Display.c:26: 	int16 dy = -abs8( y1 - 0 );
	...
	sub r10,r8	 ;  dy, _5
	sbc r11,r9	 ;  dy, _5
 ;  Display.c:27: 	int8 sy = y0 < y1 ? 1 : -1;
...
.L8:
	...
	mov r25,r24	 ;  Idx, x0
	andi r25,lo8(7)	 ;  Idx,
 ;  Display.h:38: 	const byte Mask = mask( Idx );
	clr r12		 ;  tmp89
	inc r12		 ;  tmp89
	mov r13,__zero_reg__	 ; 
.L9:
 ;  Display.h:39: 	LCDBuffer[Block] |= Mask;
	...
	or r30,r7		 ;  tmp90, *_47
	st X,r30		 ;  *_47, tmp90
 ;  Display.c:32: 		if ( x0 == x1 && y0 == y1 ) break;
	cp r24,r20		 ;  x0, x1
	breq .L16		 ; ,
.L10:
 ;  Display.c:33: 		e2 = 2 * err;
	movw r30,r28	 ;  e2, err
	lsl r30	 ;  e2
	rol r31	 ;  e2
 ;  Display.c:34: 		if ( e2 >= dy ) {
	cp r30,r10	 ;  e2, dy
	cpc r31,r11	 ;  e2, dy
	brlt .L12		 ; ,
	sub r28,r8	 ;  err, _5
